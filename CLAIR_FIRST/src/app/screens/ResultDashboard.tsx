    ...
    <div className="space-y-3">
      <div className="rounded-[18px] border border-red-100 bg-red-50 p-4">
        <div className="flex items-start gap-3">
          <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-[12px] bg-gradient-to-br from-red-500 to-orange-500 text-white">
          ...
          <div>
            ...
            <p className="mt-2 text-[13px] leading-6 text-slate-600">
              초과 근무 수당 지급 기준이 명확하게 적혀 있지 않습니다.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-[18px] border border-amber-100 bg-amber-50 p-4">
        <div className="flex items-start gap-3">
          <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-[12px] bg-gradient-to-br from-yellow-500 to-amber-500 text-white">
            <Info size={15} />
          </div>
          <div>
            <div className="flex items-center gap-2">
            ...
            <p className="mt-2 text-[13px] leading-6 text-slate-600">
              퇴사 후 2년간 동종 업계 취업 제한 조항이 포함되어 있습니다.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-[18px] border border-emerald-100 bg-emerald-50 p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-2 text-[13px] leading-6 text-slate-600">
              연차 휴가 관련 내용은 비교적 적절하게 작성되어 있습니다.
            </p>
          </div>
        </div>
      </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex items-center gap-2">
                        ...
                        <span className="text-[13px] text-slate-500">분석 완료</span>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <div className="rounded-[24px] border border-slate-100 bg-white p-4 shadow-sm">
                        ...
                        <div className="mt-4 rounded-[18px] bg-[#F8FAFF] p-4">
                          ...
                          <p className="mt-2 text-[13px] leading-6 text-slate-500">
                            초과 근무 수당, 경업금지 조항, 해지 조건을 우선 확인해보세요.
                          </p>
                        </div>
